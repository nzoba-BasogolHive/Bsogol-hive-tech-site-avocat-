        ...
        <Reveal>
          ...
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-14 md:mb-20">
            <div>
              <div className="flex items-center gap-3 mb-5">
                ...
                <p
                  className="text-[#1b0f6b] text-[10px] font-bold tracking-[0.3em] uppercase"
              ...
              <h2
                className="font-bold text-[#0f1545] leading-[1.15]"
                style={{
          ...
          >
            ...
            <div className="flex flex-col justify-center p-8 md:p-12 flex-1">
              ...
              <h3
                className="text-[#0a0814] font-bold leading-[1.25] mb-4 group-hover:text-[#1b0f6b] transition-colors duration-300"
                style={{
                  fontFamily: "Garamond, serif",
              ...
              <p className="text-gray-500 text-[14px] leading-[1.8] mb-8 max-w-lg">
          ...
          <div>
            <p
              className="text-center text-[#0f1545] mb-10 md:mb-14"
              style={{
                fontFamily: "Garamond, serif",
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
              {sujets.map(({ slug, label, image }) => (
                ...
                >
                  ...
                  <div>
                    <h4
                      className="text-[#0f1545] font-semibold group-hover:text-[#1b0f6b] transition-colors duration-300 leading-snug text-sm md:text-base"
                      style={{ fontFamily: "Garamond, serif" }}
                    >
                      {label}
                    </h4>
